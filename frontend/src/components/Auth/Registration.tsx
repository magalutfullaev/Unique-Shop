...
const Registration: React.FC<RegistrationProp> = ({closeModal, toLogin}) => {
    return (
        <div className="modal">
            <button className='close-modal' onClick={closeModal}>&times;</button>
            <h3 className='title'>Зарегистрироваться</h3>
            <p className='subtitle'>Введите данные, необходимые для создания учтеной записи</p>
            ...
            <div className="btns">
                <button className='btn btn-solid' onClick={closeModal}>Зарегистрироваться</button>
            </div>
            <p className="subtitle">У вас уже есть аккаунт? <a className='btn btn-link' onClick={toLogin}>Войдите в свою
                учетную запись</a></p>
